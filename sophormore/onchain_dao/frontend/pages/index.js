              ...
              {p.deadline.getTime() > Date.now() && !p.executed ? (
                <div className={styles.flex}>
                  <button
                    ...
                    onClick={() => voteForProposal(index, "YAY")}
                  >
                    Vote YAY
                  </button>
                  <button
                    className={styles.button2}
                    onClick={() => voteForProposal(index, "NAY")}
                  >
                    Vote NAY
                  </button>
                </div>
    ...
    <div className={inter.className}>
      ...
      <div className={styles.main}>
        <div>
          ...
          <div className={styles.description}>
            Your CryptoDevs NFT Balance: {parseInt(nftBalanceOfUser?.data)}
            <br />
            {daoBalance.data && (
              <>
                Treasury Balance:{" "}
            ...
            <br />
            Total Number of Proposals: {parseInt(numOfProposalsInDAO?.data)}
          </div>
          <div className={styles.flex}>
            <button
          ...
          {address && address.toLowerCase() === daoOwner.data ? (
            <div>
              {loading ? (
