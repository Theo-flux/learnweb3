...
contract LW3Punks is ERC721Enumerable, Ownable {
    ...
    */
    ...
    // maxTokens is the max number of tokens.
    uint256 public maxLW3PunksTokens = 10;

    // no of tokensId minted.
    uint256 public tokenIds;

    modifier onlyWhenNotPaused {
        require(!_paused, "Contract currenlty paused");
        _;
    }
    ...
    */
    constructor(string memory baseURI) ERC721("LW3Punks", "LWP") Ownable(msg.sender){
    ...
    */
    function mint() public payable onlyWhenNotPaused() {
        require(tokenIds < maxLW3PunksTokens, "Max number of LW3Punks NFT exceeded.");
